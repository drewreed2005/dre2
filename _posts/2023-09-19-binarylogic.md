...
description: Notes from the lesson on boolean logic.
courses: { csa: {week: 8} }
type: hacks
---
...
## De Morgan's Law (IMPORTANT)

(see diagram [on site](https://the-code-monkeys.github.io/Monkeys38//2023/09/19/binarylogic.html))
